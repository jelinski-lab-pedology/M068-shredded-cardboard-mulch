...
ggplot(subset(weed_biomass, year == "2023"), aes(x = weeding_point, y = od_g, fill = treatment)) + geom_boxplot() 

ggplot(subset(weed_biomass, year == "2024"), aes(x = weeding_point, y = od_g, fill = treatment)) + geom_boxplot() 
