...
ggplot(subset(weed_biomass, year == "2023"), aes(x = weeding_point, y = biomass_g_m2, fill = treatment)) + geom_boxplot() 

ggplot(subset(weed_biomass, year == "2024"), aes(x = weeding_point, y = biomass_g_m2, fill = treatment)) + geom_boxplot() 

#crops and weeding point combined, visualized by treatment for each year
ggplot(weed_biomass, aes(x = as.factor(year), y = biomass_g_m2, fill = treatment)) + geom_boxplot()
...
ggplot(data = subset(weed_biomass, year == "2023"), 
  ...
  annotate("text", x = 0.75, y = 130, label = "a") +
  annotate("text", x = 1, y = 130, label = "b") +
  annotate("text", x = 1.25, y = 130, label = "ab") +
  annotate("text", x = 1.75, y = 110, label = "a") +
  annotate("text", x = 2, y = 110, label = "b") +
  annotate("text", x = 2.25, y = 110, label = "ac") +
  annotate("text", x = 2.75, y = 30, label = "a") +
  annotate("text", x = 3, y = 30, label = "a") +
  annotate("text", x = 3.25, y = 30, label = "a") +
  annotate("text", x = 3.75, y = 30, label = "a") +
  annotate("text", x = 4, y = 30, label = "a") +
  annotate("text", x = 4.25, y = 30, label = "a")

ggsave("20250915_SCM_biomass_2023.png", width = 6, height = 4)
...
ggplot(data = subset(weed_biomass, year == "2024"), 
  ...
  guides(fill = FALSE) +
  annotate("text", x = 0.75, y = 235, label = "a") +
  annotate("text", x = 1, y = 235, label = "b") +
  annotate("text", x = 1.25, y = 235, label = "b") +
  annotate("text", x = 1.75, y = 590, label = "a") +
  annotate("text", x = 2, y = 590, label = "b") +
  annotate("text", x = 2.25, y = 590, label = "b") +
  annotate("text", x = 2.75, y = 320, label = "a") +
  annotate("text", x = 3, y = 320, label = "b") +
  annotate("text", x = 3.25, y = 320, label = "ab") +
  annotate("text", x = 3.75, y = 120, label = "a") +
  annotate("text", x = 4, y = 120, label = "b") +
  annotate("text", x = 4.25, y = 120, label = "a")

ggsave("20250915_SCM_biomass_2024.png", width = 6, height = 4)
...
ggplot(data = weed_labor, 
  ...
  scale_fill_manual(name = "Mulch Treatment", 
                    labels = c("Bare soil", "Shredded Cardboard", "Straw"), 
                    values = c("#A6CEE3", "#6A3D9A", "#CAB2D6")) +
  annotate("text", x = 0.75, y = 22, label = "a") + 
  annotate("text", x = 1, y = 22, label = "a") +
  annotate("text", x = 1.25, y = 22, label = "b") +
  annotate("text", x = 1.75, y = 22, label = "a") +
  annotate("text", x = 2, y = 22, label = "b") +
  annotate("text", x = 2.25, y = 22, label = "a")

ggsave("20250915_SCM_time.png", width = 6, height = 4)
...
ggplot(data = subset(weed_labor, year == "2023"), 
  ...
  scale_fill_manual(name = "Mulch Treatment", 
                    ...
                    values = c("#A6CEE3", "#6A3D9A", "#CAB2D6")) +
  scale_x_discrete(labels = c("2", "4", "6", "9")) +
  annotate("text", x = 0.75, y = 19, label = "a") + 
  annotate("text", x = 1, y = 19, label = "a") +
  annotate("text", x = 1.25, y = 19, label = "b") +
  annotate("text", x = 1.75, y = 12, label = "a") +
  annotate("text", x = 2, y = 12, label = "a") +
  annotate("text", x = 2.25, y = 12, label = "b") +
  annotate("text", x = 2.75, y = 12, label = "a") +
  annotate("text", x = 3, y = 12, label = "a") +
  annotate("text", x = 3.25, y = 12, label = "b") +
  annotate("text", x = 3.75, y = 6, label = "ab") +
  annotate("text", x = 4, y = 6, label = "a") +
  annotate("text", x = 4.25, y = 6, label = "b")

ggsave("20250915_SCM_time_2023.png", width = 6, height = 4)
...
ggplot(data = subset(weed_labor, year == "2024"), 
  ...
  ylim(0,22.5) +
  scale_x_discrete(labels = c("2", "5", "7", "11")) +
  annotate("text", x = 0.75, y = 16, label = "a") + 
  annotate("text", x = 1, y = 16, label = "a") +
  annotate("text", x = 1.25, y = 16, label = "a") +
  annotate("text", x = 1.75, y = 22, label = "a") +
  annotate("text", x = 2, y = 22, label = "b") +
  annotate("text", x = 2.25, y = 22, label = "a") +
  annotate("text", x = 2.75, y = 22, label = "a") +
  annotate("text", x = 3, y = 22, label = "a") +
  annotate("text", x = 3.25, y = 22, label = "a") +
  annotate("text", x = 3.75, y = 7, label = "a") +
  annotate("text", x = 4, y = 7, label = "b") +
  annotate("text", x = 4.25, y = 7, label = "a") +
  guides(fill = FALSE)

ggsave("20250915_SCM_time_2024.png", width = 6, height = 4)
...
I did this earlier, but it needs to be at the end of the script so it doesn't interfere with previous code
