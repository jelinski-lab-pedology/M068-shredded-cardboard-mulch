...
df <- data.frame(precip_cm = c(1.2, 36.8))
df$precip_Lconvert_precip(precip_cm, 
                                                         old_metric = "inches", 
                                                         new_metric = "mm", 
                                                         round = 2)
...
ggplot() + 
  geom_line(data = subset(soil_temp_trt, date < "2024-07-02"), 
       aes(x = date, 
           y = trt_avg, 
           color = treatment)) +
  geom_line(data = subset(temp_precip_day, date > "2023-05-22" & date < "2024-07-02"), 
            aes(x = date, 
                y = avg_temp_C), color = "gray", linetype = 2) +
  theme_bw() +
  ...
  scale_color_manual(name = "Mulch Treatment", 
    ...
    scale_x_date(breaks = as.Date(c("2023-06-01",
               ...
               minor_breaks = as.Date(c("2023-05-01",
                                  ...
                                  "2024-05-01",
                                  "2024-07-01")),
               labels = c("Jun 2023", "Aug 2023", "Oct 2023", "Dec 2023",
                          "Feb 2024", "Apr 2024", "Jun 2024")) + 
   annotate("text", x = as.Date("2023-06-22"), y = 27, label = "*", size = 10) +
   annotate("text", x = as.Date("2024-06-02"), y = 23, label = "*", size = 10)

ggsave("20250913_SCM_soil_temp_avg.png")
...
```{r}
ggplot() + 
  geom_line(data = subset(soil_temp_trt, date < "2024-07-01"), 
       aes(x = date, 
           y = trt_dif, 
  ...
  scale_x_date(breaks = as.Date(c("2023-06-01",
               ...
               labels = c("Jun 2023", "Aug 2023", "Oct 2023", "Dec 2023",
                          "Feb 2024", "Apr 2024", "Jun 2024")) + 
   annotate("text", x = as.Date("2023-06-22"), y = 6, label = "*", size = 10) +
   annotate("text", x = as.Date("2024-06-02"), y = 10, label = "*", size = 10) 

ggsave("20250913_SCM_soil_temp_dif.png")
...
ggsave("20250913_SCM_soil_temp_2023.png", width = 6, height = 4)
```
...
soil_vwc$season <- ifelse(soil_vwc$month < 8, "early",
                          "late")
...
#write.csv(sum_stat_vwc, here::here("202501015_SCM_soil_vwc.csv"), row.names=TRUE)

#LMM
model <- lmer(vwc_percent ~ treatment + (1 | sample_date) + (1 | block), data = subset(soil_vwc_23, season == "early"))
AIC(model)
summary(model)
...
#ANOVA
model <- aov(vwc_percent ~ treatment, data = subset(soil_vwc_24, season == "late"))
AIC(model)
summary(model)
TukeyHSD(model)
plot(model)
...
#KW
kruskal.test(vwc_percent~treatment, data = subset(soil_vwc_23, season == "late"))
dunnTest(vwc_percent~treatment, data = subset(soil_vwc_24, season == "late"))
```
...
ggplot(data = soil_vwc_rt, 
  ...
  scale_x_datetime(breaks = as.POSIXct(c("2023-07-01", 
               ...
               labels = c("Jul 2023", "Aug 2023", "Sept 2023",
                          "Oct 2023")) +
   annotate("text", x = as.POSIXct("2023-09-30"), y = 43, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-04"), y = 37, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-09-24"), y = 41, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-07-26"), y = 32, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-14"), y = 37, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-12"), y = 37, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-07-05"), y = 37, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-07-29"), y = 32, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-03"), y = 32, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-09-26"), y = 41, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-09-29"), y = 43, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-09-25"), y = 41, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-07-25"), y = 15, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-11"), y = 27, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-09-12"), y = 17, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-07"), y = 27, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-07-14"), y = 15, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-09-15"), y = 17, label = "*", size = 7) +
   annotate("text", x = as.POSIXct("2023-08-15"), y = 37, label = "*", size = 7) 

ggsave("20250913_SCM_vwc_rt.png", height = 4, width = 6)
